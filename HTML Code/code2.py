# Creating a I love You animation using turtel,time,pygame MODULES

import turtle
import time
from pygame import mixer
# You can add your own music as per your chioce
# Initialize pygame mixer
mixer.pre_init(frequency=48000, size=-16, channels=2, buffer=512)
mixer.init()
mixer.music.load("https://open.spotify.com/track/5nsET7aVWXu017lsQjRFCV?si=cc3b1dee71b34ae6")
...
# call the function for the animatation popup
love_sign()
